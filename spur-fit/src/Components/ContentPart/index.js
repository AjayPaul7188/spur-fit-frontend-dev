...
const ContentPart = () => {
    ...
    const sections = ['first-page', 'part-3', 'part-4', 'part-5', 'part-6', 'part-7', 'part-8', 'part-9']
    ...
    useEffect(() => {
        ...
        gsap.to(['.img1', '.img3', '.flow-img', '.img6' ], {
            rotation: 360,
            duration: 5,
            repeat: -1,
          });

          gsap.from('.heading', {opacity: 0, x: -40, duration: 3, scrollTrigger: {
            trigger: '.heading',
          }});
        
          gsap.from('.head1', {opacity: 0, x: -40, duration: 3, scrollTrigger: {
            trigger: '.head1',
          }});
